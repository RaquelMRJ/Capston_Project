...
class S3ToPostgresTransfer(BaseOperator):
    ...
    def execute(self, context):
        ...
        df_products = df_user_purchase.replace(r"[\"]", r"'")
        ...
        nombre_de_archivo = "dbpostgres.user_purchase.sql"
        
        ruta_archivo = '/usr/local/airflow/dags/custom_modules/assets' + os.path.sep + nombre_de_archivo
